...
ver_speed = conn.add_stream(getattr, vessel.flight(
    vessel.orbit.body.reference_frame), 'vertical_speed')
hor_speed = conn.add_stream(getattr, vessel.flight(
    vessel.orbit.body.reference_frame), 'horizontal_speed')
vel = conn.add_stream(getattr, vessel.flight(
...
while srf_altitude() != tgt_altitude:
    ...
    print("\033[0;32mINFO\t\033[0;33mALT\033[0m", str(int(srf_altitude())), "\033[0;34mm\t\033[0;33mVS\033[0m", str(
        int(ver_speed())), "\033[0;34mm/s", "\t\033[0;33mHS\033[0m", str(int(hor_speed())), "\033[0;34mm/s\033[0m")
